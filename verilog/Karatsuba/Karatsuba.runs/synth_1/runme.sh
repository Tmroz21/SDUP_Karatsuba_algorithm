...
HD_PWD='C:/Users/mrozt/Desktop/SDUP/SDUP_Karatsuba_algorithm/verilog/Karatsuba/Karatsuba.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log karatsuba_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source karatsuba_multiplier.tcl
